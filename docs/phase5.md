...
- Failed saves retain the buffer and pause automatic retries. Permission/I/O errors offer explicit retry. Stale and missing paths pause without overwrite or resurrection. At the Phase 5 gate, reload/discard and save-copy were not implemented; they are now available in [Phase 6](phase6.md).
